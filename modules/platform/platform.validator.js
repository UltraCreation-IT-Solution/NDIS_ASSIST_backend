 ...
 * For GET/DELETE /api/v1/platform/settings/:key
 */
export const settingKeySchema = {
  params: Joi.object({
    key: Joi.string()
      .trim()
      .min(1)
  ...
  body: Joi.object({
    settings: Joi.array()
      ...
      .messages({
        ...
        'array.max': 'Cannot update more than 100 settings at once',
